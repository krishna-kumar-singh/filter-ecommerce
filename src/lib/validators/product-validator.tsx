...
export const AVAILABLE_SORT = [ "none","price-desc","price-asc"] as const 
...
export type ProductState= Omit<z.infer<typeof ProductFilterValidator>, "price"> & {price :{isCustom:boolean; range:[number,number]}}